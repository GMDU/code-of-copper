...
data modify entity 704a8f67-58d9-429d-8535-8eb0957136ca HandItems[0] set from storage bot:private helpers.search_inventory.output
...
data modify storage bot:private temp.item set from entity 704a8f67-58d9-429d-8535-8eb0957136ca HandItems[0]
