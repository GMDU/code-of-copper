...
execute if data storage bot:parser stack[-1].metadata{bracketed:true} if data storage bot:parser {current:")"} run function bot:parser/literal/variable/close/bracketed
