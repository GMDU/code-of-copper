...
execute if data storage bot:parser stack[-1].metadata{status:"open_value"} run data modify storage bot:parser stack[-1].metadata.pair.key set from storage bot:parser parsed.value
