...
execute if data storage bot:parser/literal {current:{variant:"alphanumeric"}} run function bot:parser/literal/alphanumeric/parse
execute if data storage bot:parser/literal {current:{variant:"string"}} run function bot:parser/literal/string/parse
execute if data storage bot:parser/literal {current:{variant:"regex"}} run function bot:parser/literal/regex/parse
...
execute if data storage bot:parser/literal {current:{variant:"object"}} run function bot:parser/literal/object/parse
