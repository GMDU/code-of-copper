...
execute unless data storage bot:parser current{flags:["meta"]} unless data storage bot:parser current{flags:["consumes"]} run function bot:parser/characters/comment
