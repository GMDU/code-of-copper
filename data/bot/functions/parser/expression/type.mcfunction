...
execute unless data storage bot:parser/expression variant if data storage moxlib:api/string/filter {output:false} run data modify storage bot:parser/expression variant set value "alphanumeric"
