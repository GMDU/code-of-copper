data merge storage bot:parser {stack:[{"type":"block",value:[],metadata:{close:{type:"single",value:"^x"}}}],raise:"",tokenise:{output:[]},current:{value:"",consumed:false,escape:{escaped:false,status:"none"}},exit:true,temp:{},close:false}
