data modify storage bot:parser temp set value ["t","r","u","e"]
execute store result score $check bot.parser run data modify storage bot:parser temp set from storage bot:parser parsed.value
...
data modify storage bot:parser temp set value ["f","a","l","s","e"]
execute store result score $check bot.parser run data modify storage bot:parser temp set from storage bot:parser parsed.value
