execute if data storage bot:parser stack[-1].metadata.close.type if data storage bot:parser current{flags:["whitespace"]} run data modify storage bot:parser current.consumed set value true
