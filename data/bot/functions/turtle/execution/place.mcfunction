...
execute store result score .dx bot.execution.pos run data get storage bot:io Out[0]
execute store result score .dy bot.execution.pos run data get storage bot:io Out[1]
execute store result score .dz bot.execution.pos run data get storage bot:io Out[2]
