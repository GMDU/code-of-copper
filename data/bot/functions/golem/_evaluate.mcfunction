...
execute if score .type bot.execution.variables matches 0 if data storage bot:variables CurrentEvaluation{type:"literal",variant:"variable"} run scoreboard players set .type bot.execution.variables 2
execute if score .type bot.execution.variables matches 0 if data storage bot:variables CurrentEvaluation{type:"literal"} run scoreboard players set .type bot.execution.variables 1
...
execute if score .type bot.execution.variables matches 2 run function bot:golem/evaluate/variable
