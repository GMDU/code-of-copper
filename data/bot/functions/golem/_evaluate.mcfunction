...
execute if score .type bot.execution.variables matches 0 if data storage bot:variables CurrentEvaluation{type:"literal",variant:"number"} run scoreboard players set .type bot.execution.variables 1
...
execute if score .type bot.execution.variables matches 0 if data storage bot:variables CurrentEvaluation{type:"expression"} run scoreboard players set .type bot.execution.variables 5

execute if score .type bot.execution.variables matches 1 run function bot:golem/evaluate/number
...
execute if score .type bot.execution.variables matches 5 run function bot:golem/evaluate/expression
