...
execute at @s unless data storage bot:program Error unless block ~ ~-0.01 ~ #bot:traversable store result entity @s Pos[1] double 0.001 run scoreboard players operation .y bot.execution.pos += .dy bot.execution.pos
