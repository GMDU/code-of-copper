...
execute unless data storage bot:io Out{recieved:false} unless data storage bot:program Error at @s run function bot:golem/execution/place/break_or_place
