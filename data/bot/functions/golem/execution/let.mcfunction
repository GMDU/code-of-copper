...
execute if data storage bot:interpreter/execution {varName:["I","N","V","E","N","T","O","R","Y"]} run data modify storage bot:program Error set value ["let: The INVENTORY variable is immutable"]
execute if data storage bot:interpreter/execution {varName:["B","L","O","C","K"]} run data modify storage bot:program Error set value ["let: The BLOCK variable is immutable"]
