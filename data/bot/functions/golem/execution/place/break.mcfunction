...
data modify storage bot:variables temp set from entity @s Items
...
execute store result score .success bot.execution.variables run data modify storage bot:variables temp set from entity @s Items
...
execute if block ~ ~ ~ #bot:container run function bot:golem/execution/place/break_container
