...
function bot:golem/execution/place/dynamic_or_manual
...
execute if data entity @e[type=falling_block,tag=moxlib.helpers.block.place,sort=nearest,limit=1] BlockState{Name:"minecraft:sand"} unless data storage bot:io In{id:"minecraft:sand"} run function bot:golem/execution/place/no_block
