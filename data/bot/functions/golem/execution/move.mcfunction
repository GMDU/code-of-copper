...
execute unless data storage bot:io Out{type:"array"} run data modify storage bot:program Error set value ["move: expected type array for vector3D parameter, but got type "]
