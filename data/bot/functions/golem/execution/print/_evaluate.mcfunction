...
data modify storage bot:interpreter/execution CurrentEvaluation set from storage bot:interpreter/execution/evaluate stack[-1]
...
execute if score .type bot.execution.variables matches 0 run data modify storage bot:program Error append from storage bot:interpreter/execution CurrentEvaluation.type
...
data remove storage bot:interpreter/execution/evaluate stack[-1]
scoreboard players set .type bot.execution.variables 0
