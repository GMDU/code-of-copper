...
execute if score .type bot.execution.variables matches 0 if data storage bot:variables CurrentEvaluation{type:"number"} run scoreboard players set .type bot.execution.variables 1
...
execute if score .type bot.execution.variables matches 0 if data storage bot:variables CurrentEvaluation{type:"object"} run scoreboard players set .type bot.execution.variables 3
execute if score .type bot.execution.variables matches 0 if data storage bot:variables CurrentEvaluation{type:"boolean"} run scoreboard players set .type bot.execution.variables 4
