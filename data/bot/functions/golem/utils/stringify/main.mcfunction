...
execute if score .type bot.execution.variables matches 1 run function bot:golem/utils/stringify/integer
execute if score .type bot.execution.variables matches 2 run function bot:golem/utils/stringify/string
execute if score .type bot.execution.variables matches 3 run function bot:golem/utils/stringify/regex
execute if score .type bot.execution.variables matches 4 run function bot:golem/utils/stringify/array
execute if score .type bot.execution.variables matches 5 run function bot:golem/utils/stringify/object
