...
data modify storage moxlib:api/string/to_array target set from storage bot:variables Inventory[0].id
...
execute if data storage bot:variables Inventory[0] run function bot:golem/evaluate/variable/inventory_loop
