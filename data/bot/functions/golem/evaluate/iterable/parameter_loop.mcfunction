...
execute unless data storage bot:interpreter/evaluate Parameterise{type:"string"} unless data storage bot:interpreter/evaluate Parameterise{type:"array"} unless data storage bot:interpreter/evaluate Parameterise{type:"object"} run data modify storage bot:program Error set value ["Can't index type "]
execute unless data storage bot:interpreter/evaluate Parameterise{type:"string"} unless data storage bot:interpreter/evaluate Parameterise{type:"array"} unless data storage bot:interpreter/evaluate Parameterise{type:"object"} run data modify storage bot:program Error append from storage bot:interpreter/evaluate Parameterise.type
