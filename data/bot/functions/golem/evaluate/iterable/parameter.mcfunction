...
execute unless data storage bot:io Out{type:"integer"} run data modify storage bot:program Error set value ["Expected type integer for array/string index, but got type "]
