data modify storage bot:io In set from storage bot:interpreter/evaluate expressionStack[-1].expressionValue.value
data modify storage bot:io In2 set from storage bot:interpreter/evaluate expressionStack[-1].expressionExpression.value
