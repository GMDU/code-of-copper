...
execute if data storage bot:interpreter/expression stack[-1].expressionValue.value[0] run function bot:golem/evaluate/expression/operations/subtract/object_loop
