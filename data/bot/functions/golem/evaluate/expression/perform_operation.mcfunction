data modify storage bot:variables operation set from storage bot:variables stack[-1].operation
execute store result score .value bot.execution.variables run data get storage bot:variables expressionStack[-1].expressionValue.value
execute store result score .expression bot.execution.variables run data get storage bot:variables expressionStack[-1].expressionExpression.value
