...
execute if data storage bot:variables RecursiveEvaluation.arrayEvaluationStack[-1][0] run function bot:golem/evaluate/array/loop
...
execute if data storage bot:variables RecursiveEvaluation.evaluateStack[-1].hasParameters run data modify storage bot:variables Parameterise set from storage bot:io Out
