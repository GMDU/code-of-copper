...
execute on passengers as @s[type=marker,tag=bot.golem.brain] if data entity @s data{status:"active"} unless data entity @s data.RunRootStack[-1] run data modify entity @s data.RunRootStack append from entity @s data.compiled
