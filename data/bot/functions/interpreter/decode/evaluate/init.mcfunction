...
execute if data storage bot:interpreter evaluate.current{type:"literal",variant:"string"} run function bot:interpreter/decode/evaluate/string/init
execute if data storage bot:interpreter evaluate.current{type:"literal",variant:"variable"} run function bot:interpreter/decode/evaluate/variable/init
execute if data storage bot:interpreter evaluate.current{type:"literal",variant:"function"} run function bot:interpreter/decode/evaluate/function/init
