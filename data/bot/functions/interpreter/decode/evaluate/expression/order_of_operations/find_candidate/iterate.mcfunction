...
execute if score .precedence bot.interpreter < .candidate_precedence bot.interpreter run function bot:interpreter/decode/evaluate/expression/order_of_operations/find_candidate/select
...
execute if data storage bot:interpreter evaluate.order_of_operations.temp[1] run function bot:interpreter/decode/evaluate/expression/order_of_operations/find_candidate/iterate
