...
data modify storage bot:interpreter evaluate.stack[-1].evaluated_value append from storage bot:interpreter evaluate.stack[-1].metadata.stack[0]
data modify storage bot:interpreter evaluate.stack[-1].evaluated_value[-1].value set from storage bot:interpreter evaluate.result
