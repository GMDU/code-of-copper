...
execute on passengers as @s[type=marker,tag=bot.golem.brain] unless data entity @s data.instructions[-1].sleepTime run data modify entity @s data.instructions[-1].sleepTime set from storage bot:interpreter/execution current.decoded_args[0].value
