...
execute store result score .dx bot.execution.pos run data get storage bot:interpreter/execution current.decoded_args[1].value[0].value 1000
execute store result score .dy bot.execution.pos run data get storage bot:interpreter/execution current.decoded_args[1].value[1].value 1000
execute store result score .dz bot.execution.pos run data get storage bot:interpreter/execution current.decoded_args[1].value[2].value 1000
function bot:interpreter/execution/place/assert_in_range
...
execute unless data storage bot:interpreter/execution Error store result entity @s Pos[1] double 0.001 run scoreboard players operation .y bot.execution.pos += .dy bot.execution.pos
