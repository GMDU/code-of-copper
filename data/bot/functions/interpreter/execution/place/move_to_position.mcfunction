...
execute store result score .dx bot.execution.pos run data get storage bot:interpreter/execution Current.args[1].value[0].value 1000
execute store result score .dy bot.execution.pos run data get storage bot:interpreter/execution Current.args[1].value[1].value 1000
execute store result score .dz bot.execution.pos run data get storage bot:interpreter/execution Current.args[1].value[2].value 1000
