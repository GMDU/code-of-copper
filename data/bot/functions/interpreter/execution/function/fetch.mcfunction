...
data modify storage moxlib:api/data/get key.name set from storage bot:interpreter/execution current.name
...
execute if data storage moxlib:api/data/get {success:false} run data modify storage bot:interpreter/execution Error[1] set from storage bot:interpreter/execution current.name.value
