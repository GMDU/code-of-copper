...
execute if score .error bot.execution.variables matches 1 run data modify storage bot:interpreter/execution Error[0] set from storage bot:interpreter/execution current.name.value
