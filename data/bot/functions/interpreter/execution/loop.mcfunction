...
execute on passengers as @s[type=marker,tag=bot.golem.brain] unless data entity @s data.instructions[-1].loops run data modify entity @s data.instructions[-1].loops set from storage bot:io Out.value
