...
execute on passengers as @s[type=marker,tag=bot.golem.brain] unless data entity @s data.instructions[-1].loops run data modify entity @s data.instructions[-1].loops set from storage bot:interpreter/execution current.decoded_args[0].value
...
execute unless score .loops bot.execution.variables matches ..-1 on passengers as @s[type=marker,tag=bot.golem.brain] run data modify entity @s data.instructions append from storage bot:interpreter/execution current.decoded_args[1]
