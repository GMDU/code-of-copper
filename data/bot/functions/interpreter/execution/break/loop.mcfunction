...
execute unless data storage bot:interpreter/execution last_instruction{isLooping:true} run data remove entity @s data.instructions[-1]
execute if data storage bot:interpreter/execution last_instruction{isLooping:true} run data modify entity @s data.instructions[-1].isLooping set value false
