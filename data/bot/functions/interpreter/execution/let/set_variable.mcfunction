...
data modify storage moxlib:api/data/set key set value {name:"",scope:0}
...
execute if data storage moxlib:api/data/get {success:true} run data modify storage moxlib:api/data/set key.scope set from storage moxlib:api/data/get output.scope
execute if data storage moxlib:api/data/get {success:false} on passengers as @s[type=marker,tag=bot.golem.brain] run data modify storage moxlib:api/data/set key.scope set from entity @s data.nest_level
