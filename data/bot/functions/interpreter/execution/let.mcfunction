data modify storage bot:interpreter/execution varName set from storage bot:interpreter/execution Current.args[0].value
data modify storage bot:interpreter/execution value set from storage bot:interpreter/execution Current.args[1]
