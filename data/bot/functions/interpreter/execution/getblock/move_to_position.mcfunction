...
execute store result score .dx bot.execution.pos run data get storage bot:interpreter/execution current.decoded_args[0].value 1000
execute store result score .dy bot.execution.pos run data get storage bot:interpreter/execution current.decoded_args[1].value 1000
execute store result score .dz bot.execution.pos run data get storage bot:interpreter/execution current.decoded_args[2].value 1000
function bot:interpreter/execution/getblock/assert_in_range
