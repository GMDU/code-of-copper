...
data remove storage bot:utils sort.stack[-1].target[0]

execute if data storage bot:utils sort.stack[-1].target[] run function bot:interpreter/utils/sort/partition/iterate with storage bot:utils sort