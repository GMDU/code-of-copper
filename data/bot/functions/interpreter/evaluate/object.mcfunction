...
data modify storage bot:dev_mode logs append value '[{"text": "Evaluate: evaluating object ", "color": "green"},{"nbt":"stack[-1].value", "storage": "bot:interpreter/evaluate","color":"yellow"},{"text": ", got ", "color": "green"},{"nbt": "Out", "storage": "bot:io", "color": "yellow"}]'
