...
execute unless data storage bot:interpreter/evaluate stack[-1].evaluated.b if data storage bot:interpreter/evaluate stack[-1].evaluated.a run function bot:interpreter/evaluate/binary_operation/evaluate_b
