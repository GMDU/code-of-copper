execute if data storage bot:interpreter/evaluate Parameterise{type:"array"} run function bot:interpreter/evaluate/array/parameter
execute if data storage bot:interpreter/evaluate Parameterise{type:"string"} run function bot:interpreter/evaluate/string/parameter
execute if data storage bot:interpreter/evaluate Parameterise{type:"object"} run function bot:interpreter/evaluate/object/parameter
...
execute if data storage bot:interpreter/evaluate stack[-1].parameters[0] run function bot:interpreter/evaluate/iterable/parameter_loop
