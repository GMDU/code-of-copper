...
data modify storage moxlib:api/data/set key.key set from storage bot:interpreter/expression stack[-1].expressionExpression.value[0].key
data modify storage moxlib:api/data/set data set value {value: []}
data modify storage moxlib:api/data/set data.value set from storage bot:interpreter/expression stack[-1].expressionExpression.value[0].value
function moxlib:api/data/set

data modify storage bot:io Out.value set from storage moxlib:api/data/set output

data remove storage bot:interpreter/expression stack[-1].expressionExpression.value[0]
