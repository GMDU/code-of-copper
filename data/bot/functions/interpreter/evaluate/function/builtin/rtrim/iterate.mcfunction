data modify storage moxlib:api/string/ascii/encode target set from storage bot:api/interpreter/function execute.return.value[-1]
...
data remove storage bot:api/interpreter/function execute.return.value[-1]
