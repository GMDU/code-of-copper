...
execute store result score $dx bot.interpreter run data get storage bot:interpreter evaluate.stack[-1].args[0].value
...
execute store result score $dy bot.interpreter run data get storage bot:interpreter evaluate.stack[-1].args[1].value
...
execute store result score $dz bot.interpreter run data get storage bot:interpreter evaluate.stack[-1].args[2].value
...
data modify storage bot:api/interpreter/function execute.return set value {type: "literal", variant: "resource", value: true, namespace:[m,i,n,e,c,r,a,f,t]}
data modify storage bot:api/interpreter/function execute.return.id set from storage moxlib:api/string/to_array output
