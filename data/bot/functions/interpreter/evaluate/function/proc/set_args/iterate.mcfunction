data modify storage bot:interpreter evaluate.variable.name.value set from storage bot:interpreter temp.parameters[0]
...
execute if data storage bot:interpreter evaluate.stack[-1].args[] run function bot:interpreter/evaluate/function/proc/set_args/iterate
