...
data modify storage bot:interpreter evaluate.binary_operation.result.original_value append from storage bot:interpreter evaluate.stack[-1].b.original_value[]