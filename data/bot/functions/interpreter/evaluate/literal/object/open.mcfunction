...
data modify storage bot:interpreter evaluate.stack[-1].value append from storage bot:interpreter evaluate.stack[-1].metadata.stack[0]
data modify storage bot:interpreter evaluate.stack[-1].value[-1].value set from storage bot:interpreter evaluate.result
