...
execute if data storage bot:interpreter temp.instruction{type:"function"} run data modify storage bot:interpreter error set value '{"text":"RuntimeError: Cannot use next outside of a loop"}'
