...
data modify storage bot:dev_mode logs append value '[{"text": "Evaluate: evaluating variable ", "color": "green"},{"nbt":"stack[-1].value", "storage": "bot:interpreter/evaluate","interpret": true,"color":"yellow"},{"text": ", got ", "color": "green"},{"nbt": "{}", "storage": "moxlib:api/data/get", "color": "yellow"}]'
