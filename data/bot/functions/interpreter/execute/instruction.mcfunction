...
execute if data storage bot:interpreter/execution current{variant:"var"} run function bot:interpreter/execution/var
...
execute if data storage bot:interpreter/execution current{variant:"return"} run function bot:interpreter/execution/return
